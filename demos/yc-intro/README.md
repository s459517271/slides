...
```bash
# 1. 登录 inference.sh (需要先获取 API key)
# 访问：https://app.inference.sh/settings/keys
infsh login --key YOUR_API_KEY

# 2. 运行生成脚本
cd /Users/ajtoy/retro-pop-ppt/demos/yc-intro
./generate-all.sh
...
| 元素 | 内容 |
|------|------|
| 标题 | What is Y Combinator? |
| 副标题 | The World's Most Famous Startup Accelerator |
| 数据 | 2005 founded • 4000+ companies • $600B+ valuation |
...
demos/yc-intro/
├── images/
│   ├── retro-pop-art-en.png
│   ├── retro-pop-art-cn.png
│   ├── minimalist-clean-en.png
│   ├── minimalist-clean-cn.png
│   ├── cyberpunk-neon-en.png
│   ├── cyberpunk-neon-cn.png
│   ├── neo-brutalism-en.png
│   ├── neo-brutalism-cn.png
│   ├── acid-graphics-Y2K-en.png
│   ├── acid-graphics-Y2K-cn.png
│   ├── modern-minimal-pop-en.png
│   ├── modern-minimal-pop-cn.png
│   ├── Swiss-international-en.png
│   ├── Swiss-international-cn.png
│   ├── dark-editorial-en.png
│   ├── dark-editorial-cn.png
│   ├── design-blueprint-Figma-en.png
│   ├── design-blueprint-Figma-cn.png
...
# 保存到文件
infsh app run falai/flux-dev-lora --input '...' --save result.json
```
